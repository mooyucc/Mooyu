...
**请基于你的知识库和训练数据中的信息进行查询。如果信息不足，请基于已知信息进行合理推理，并在返回结果中注明信息来源的局限性。**
...
9. **IB课程**：
   - IB PYP（有/无，如果有请填写"有"，否则填"无"）
   - IB MYP（有/无，如果有请填写"有"，否则填"无"）
   - IB DP（有/无，如果有请填写"有"，否则填"无"）
   - IB CP（有/无，如果有请填写"有"，否则填"无"）

10. **其他课程**：
    - A-Level（有/无，如果有请填写"有"，否则填"无"）
    - AP（有/无，如果有请填写"有"，否则填"无"）
    - 加拿大课程（有/无，如果有请填写"有"，否则填"无"）
    - 澳大利亚课程（有/无，如果有请填写"有"，否则填"无"）
    - IGCSE（有/无，如果有请填写"有"，否则填"无"）
    - 其他课程（如有，请详细列出）

...
# MooYu 服务器代码更新脚本
# 更新 MooYu 主网站的服务器代码和依赖

echo "=== MooYu 服务器代码更新脚本 ==="
echo "时间: $(date)"
echo ""
...
echo "2. 上传 MooYu 服务器代码..."
scp "/Users/kevinx/Documents/Website/Mooyu/mooyu-website/server.js" root@122.51.133.41:/root/Mooyu/
...
echo "8. 检查 MooYu 服务状态..."
ssh root@122.51.133.41 "pm2 status mooyu"

echo "9. 检查端口 3000 是否正常监听..."
...
echo ""
echo "=== MooYu 服务器代码更新完成 ==="
echo "MooYu 服务器已更新"
echo "备份位置: /root/Mooyu/server.js.backup.*"
echo ""
echo "如需回滚，请运行:"
